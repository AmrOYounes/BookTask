...
const AuthorDialog = ({
  ...
  return (
    <Dialog
      open={authorDialogState}
      onClose={() => updateDialogState("author", false)}
      fullWidth
    >
          ...
          <Form>
            <Grid container justifyContent="center" spacing={2}>
              <Grid item xs={4}>
                ...
                <TextField margin="dense" id="fName" name="fName" type="text" />
              </Grid>
              <Grid item xs={4}>
                <label>Middle name</label>
                <TextField margin="dense" id="mName" name="mName" type="text" />
              </Grid>

              <Grid item xs={4}>
                <label>Last name</label>
                <TextField margin="dense" id="lName" name="lName" type="text" />
              </Grid>
            </Grid>
            ...
            <DialogActions>
              ...
              <Button onClick={() => updateDialogState("author", false)}>
                Cancel
              </Button>
            </DialogActions>
          </Form>
